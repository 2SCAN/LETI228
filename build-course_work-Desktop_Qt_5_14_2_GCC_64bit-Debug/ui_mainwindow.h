...
public:
    ...
    QLabel *label_16;
    QLabel *label_17;
    QPushButton *color1_2;
    QPushButton *color2_2;
    QPushButton *ok_3;
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        bmp->setGeometry(QRect(0, 0, 1131, 491));
        label_2 = new QLabel(centralWidget);
        label_2->setObjectName(QString::fromUtf8("label_2"));
        label_2->setGeometry(QRect(10, 510, 101, 17));
        label_3 = new QLabel(centralWidget);
        label_3->setObjectName(QString::fromUtf8("label_3"));
        label_3->setGeometry(QRect(10, 540, 16, 17));
        label_4 = new QLabel(centralWidget);
        label_4->setObjectName(QString::fromUtf8("label_4"));
        label_4->setGeometry(QRect(10, 580, 31, 17));
        label_5 = new QLabel(centralWidget);
        label_5->setObjectName(QString::fromUtf8("label_5"));
        label_5->setGeometry(QRect(10, 620, 67, 17));
        label_6 = new QLabel(centralWidget);
        label_6->setObjectName(QString::fromUtf8("label_6"));
        label_6->setGeometry(QRect(10, 660, 21, 17));
        label_7 = new QLabel(centralWidget);
        label_7->setObjectName(QString::fromUtf8("label_7"));
        label_7->setGeometry(QRect(10, 700, 21, 17));
        label_8 = new QLabel(centralWidget);
        label_8->setObjectName(QString::fromUtf8("label_8"));
        label_8->setGeometry(QRect(10, 740, 21, 17));
        x0 = new QLineEdit(centralWidget);
        x0->setObjectName(QString::fromUtf8("x0"));
        x0->setGeometry(QRect(40, 540, 113, 21));
        y0 = new QLineEdit(centralWidget);
        y0->setObjectName(QString::fromUtf8("y0"));
        y0->setGeometry(QRect(40, 580, 113, 21));
        x1 = new QLineEdit(centralWidget);
        x1->setObjectName(QString::fromUtf8("x1"));
        x1->setGeometry(QRect(40, 620, 113, 21));
        y1 = new QLineEdit(centralWidget);
        y1->setObjectName(QString::fromUtf8("y1"));
        y1->setGeometry(QRect(40, 660, 113, 21));
        x2 = new QLineEdit(centralWidget);
        x2->setObjectName(QString::fromUtf8("x2"));
        x2->setGeometry(QRect(40, 700, 113, 21));
        y2 = new QLineEdit(centralWidget);
        y2->setObjectName(QString::fromUtf8("y2"));
        y2->setGeometry(QRect(40, 740, 113, 21));
        ...
        ok->setGeometry(QRect(180, 780, 89, 25));
        ...
        cancel->setGeometry(QRect(1020, 780, 89, 25));
        label_12 = new QLabel(centralWidget);
        label_12->setObjectName(QString::fromUtf8("label_12"));
        label_12->setGeometry(QRect(740, 510, 101, 17));
        label_13 = new QLabel(centralWidget);
        label_13->setObjectName(QString::fromUtf8("label_13"));
        label_13->setGeometry(QRect(740, 540, 271, 17));
        label_14 = new QLabel(centralWidget);
        label_14->setObjectName(QString::fromUtf8("label_14"));
        label_14->setGeometry(QRect(740, 610, 271, 17));
        N = new QLineEdit(centralWidget);
        N->setObjectName(QString::fromUtf8("N"));
        N->setGeometry(QRect(740, 570, 113, 25));
        M = new QLineEdit(centralWidget);
        M->setObjectName(QString::fromUtf8("M"));
        M->setGeometry(QRect(740, 640, 113, 25));
        ok_2 = new QPushButton(centralWidget);
        ok_2->setObjectName(QString::fromUtf8("ok_2"));
        ok_2->setGeometry(QRect(740, 700, 89, 25));
        ...
        gridLayoutWidget->setGeometry(QRect(-1, -1, 1161, 501));
